...
public class DdConfirmArchivingConfigTest {

    private DdConfirmArchivingConfig parseConfigurationFile(String configFile) throws Exception {
        try (var validatorFactory = Validation.buildDefaultValidatorFactory()) {
            ConfigurationFactory<DdConfirmArchivingConfig> factory =
                new YamlConfigurationFactory<>(DdConfirmArchivingConfig.class,
    ...
    public void default_configuration_can_be_parsed() throws Exception {
        ...
        DdConfirmArchivingConfig configuration = parseConfigurationFile(defaultConfigFile.getAbsolutePath());
    ...
    public void debug_etc_configuration_can_be_parsed() throws Exception {
        ...
        DdConfirmArchivingConfig configuration = parseConfigurationFile(devConfigFile.getAbsolutePath());
        assertNotNull(configuration);
    }
}
